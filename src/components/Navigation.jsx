...
const Navigation = ({open}) => {
  ...
  return (
    <div className={`navigation ${close &&'close'} ${dark &&'dark'} ${open && 'open'}` }>
         <div className="left-icon" onClick={()=>setClose(prev=>!prev)}><FiChevronLeft className='left'/></div>
        <header>
...
<Nav Icon={RxDashboard} title='Dashboard' />
